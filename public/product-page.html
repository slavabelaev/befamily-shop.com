...
<div class="p-3 text-center">
    <img src="../../../public/images/product-size-popover__shirt.svg" alt="">
</div>
...
<form action="#" class="product-item card" data-product-id="0109">
    <div class="card-body">
        <a href="product.html"
           ...
           style="background-image: url(../../../public/images/content/images/products/sweater__Scandinavia/sweater__Scandinavia-1.jpg);"></a>
...
<form action="#" class="product-item card" data-product-id="0110">
    <div class="card-body">
        <a href="product.html"
           class="product-item__image"
           style="background-image: url(../../../public/images/content/images/products/sweater__Scandinavia/sweater__Scandinavia-2.jpg);"></a>
        <h3 class="product-item__title">
            <a href="product.html" class="product-item__title-link">Свитер “Скандинавия”</a>
        </h3>
        <ul class="product-item__details mb-2">
...
<figure class="review-item figure">
    <div class="review-item__avatar" style="background-image: url(../../../public/images/content/images/reviews/review__Daria-Pynzar.jpg)"></div>
...
<!-- /Review -->
    ...
    <li class="list-of-reviews__item">
        <!-- Review -->
<figure class="review-item figure">
    <div class="review-item__avatar" style="background-image: url(../../../public/images/content/images/reviews/review__Ksenia-Borodina.jpg)"></div>
    <figcaption class="figure-caption">
...
<div class="complect-item card">
    <div class="card-body">
        ...
        <a href="product.html?complectId=0109" class="complect-item__image" style="background-image: url(../../../public/images/content/images/complects/complect__example-1.jpg);"></a>
...
<div class="complect-item card">
    <div class="card-body">
        ...
        <a href="product.html?complectId=0110" class="complect-item__image" style="background-image: url(../../../public/images/content/images/complects/complect__example-2.jpg);"></a>
        <h3 class="complect-item__title">
...
<div class="complect-item card">
    <div class="card-body">
        ...
        <a href="product.html?complectId=0111" class="complect-item__image" style="background-image: url(../../../public/images/content/images/complects/complect__example-3.jpg);"></a>
        <h3 class="complect-item__title">
...
<div class="complect-item card">
    <div class="card-body">
        ...
        <a href="product.html?complectId=0112" class="complect-item__image" style="background-image: url(../../../public/images/content/images/complects/complect__example-4.jpg);"></a>
        <h3 class="complect-item__title">
...
<div class="complect-item card">
    <div class="card-body">
        ...
        <a href="product.html?complectId=0113" class="complect-item__image" style="background-image: url(../../../public/images/content/images/complects/complect__example-5.jpg);"></a>
        <h3 class="complect-item__title">
...
<div class="complect-item card">
    <div class="card-body">
        ...
        <a href="product.html?complectId=0114" class="complect-item__image" style="background-image: url(../../../public/images/content/images/complects/complect__example-6.jpg);"></a>
        <h3 class="complect-item__title">
...
<div class="complect-item card">
    <div class="card-body">
        ...
        <a href="product.html?complectId=0115" class="complect-item__image" style="background-image: url(../../../public/images/content/images/complects/complect__example-7.jpg);"></a>
        <h3 class="complect-item__title">
...
<div class="complect-item card">
    <div class="card-body">
        ...
        <a href="product.html?complectId=0116" class="complect-item__image" style="background-image: url(../../../public/images/content/images/complects/complect__example-8.jpg);"></a>
        <h3 class="complect-item__title">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-4 mb-4 mb-lg-0">
                        <a data-fancybox="gallery"
                           href="../../../public/images/scandinavia-1.jpg"
                           class="list-of-images__link">
                            <img src="../../../public/images/scandinavia-1.jpg" alt="" class="img-fluid">
                        </a>
                    </div>
                    <div class="col-lg-8">
