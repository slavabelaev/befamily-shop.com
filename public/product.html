...
<a  data-fancybox="gallery"
    ...
    <img src="images/content/complects/scandinavia/scandinavia-1.jpg" alt="" class="image-item__image">
</a>
<!-- /Image item -->
    </li>
    <li class="list-of-images__item">
        <!-- Image item -->
<a  data-fancybox="gallery"
    href="images/content/complects/scandinavia/scandinavia-2.jpg"
    class="image-item__link">
    <img src="images/content/complects/scandinavia/scandinavia-2.jpg" alt="" class="image-item__image">
</a>
<!-- /Image item -->
    </li>
    <li class="list-of-images__item">
        <!-- Image item -->
<a  data-fancybox="gallery"
    href="images/content/complects/scandinavia/scandinavia-3.jpg"
    class="image-item__link">
    <img src="images/content/complects/scandinavia/scandinavia-3.jpg" alt="" class="image-item__image">
</a>
<!-- /Image item -->
    </li>
</ul>
...
<form action="#" class="product-item card" data-product-id="0109">
    <div class="card-body">
        <a href="product.html"
           ...
           style="background-image: url(images/content/products/sweater__Scandinavia/sweater__Scandinavia-1.jpg);"></a>
...
<form action="#" class="product-item card" data-product-id="0110">
    <div class="card-body">
        <a href="product.html"
           class="product-item__image"
           style="background-image: url(images/content/products/sweater__Scandinavia/sweater__Scandinavia-2.jpg);"></a>
        <h3 class="product-item__title">
            <a href="product.html" class="product-item__title-link">Свитер “Скандинавия”</a>
        </h3>
        <ul class="product-item__details mb-2">
...
<figure class="review-item figure">
    <div class="review-item__avatar" style="background-image: url(images/content/reviews/review__Daria-Pynzar.jpg)"></div>
...
<!-- /Review -->
    ...
    <li class="list-of-reviews__item">
        <!-- Review -->
<figure class="review-item figure">
    <div class="review-item__avatar" style="background-image: url(images/content/reviews/review__Ksenia-Borodina.jpg)"></div>
    <figcaption class="figure-caption">
