...
<head>
    ...
    <link rel="stylesheet" href="/common.blocks/common.css">
</head>
<body>
<!-- /Meta header -->
<!-- Page header -->
...
<main class="index-page">
    <section class="index-page__slider">
        <!-- Page slider -->
<ul class="slider">
    <li class="slider__item" style="background-image: url(/common.blocks/slider/slider__slide-1.jpg);">
        <section class="container">
            ...
            <a href="#" class="btn btn-primary btn-lg">Подобрать свой комплект</a>
        </section>
    </li>
</ul>
<!-- /Page slider -->
    </section>
    <section class="index-page__our-catalog pt-4 pb-4">
...
<!-- Catalog tabs -->
    ...
    <section class="index-page__our-customers bg-light index-page__shaped-bg-1 pt-4 pb-4">
        <div class="container">
...
<!-- /List of famous buyers-->
    ...
    <section class="index-page__lists-by-beFamily pt-4 pb-4">
        <div class="container">
...
<ul class="list-of-special-categories row">
    <li class="list-of-special-categories__item col-md col-sm-4 col-6">
        <a href="#" class="list-of-special-categories__link">
            <figure class="list-of-special-categories__category">
                <img src="../../common.blocks/list-of-special-categories/list-of-special-categories__cinema.svg" alt="" class="list-of-special-categories__category-img">
    ...
    <li class="list-of-special-categories__item col-md col-sm-4 col-6">
        <a href="#" class="list-of-special-categories__link">
            <figure class="list-of-special-categories__category">
                <img src="../../common.blocks/list-of-special-categories/list-of-special-categories__present.svg" alt="" class="list-of-special-categories__category-img">
    ...
    <li class="list-of-special-categories__item col-md col-sm-4 col-6">
        <a href="#" class="list-of-special-categories__link">
            <figure class="list-of-special-categories__category">
                <img src="../../common.blocks/list-of-special-categories/list-of-special-categories__cake.svg" alt="" class="list-of-special-categories__category-img">
    ...
    <li class="list-of-special-categories__item col-md col-sm-4 col-6">
        <a href="#" class="list-of-special-categories__link">
            <figure class="list-of-special-categories__category">
                <img src="../../common.blocks/list-of-special-categories/list-of-special-categories__clothes.svg" alt="" class="list-of-special-categories__category-img">
    ...
    <li class="list-of-special-categories__item col-md col-sm-4 col-6">
        <a href="#" class="list-of-special-categories__link">
            <figure class="list-of-special-categories__category">
                <img src="../../common.blocks/list-of-special-categories/list-of-special-categories__sun-umbrella.svg" alt="" class="list-of-special-categories__category-img">
    ...
    <li class="list-of-special-categories__item col-md col-sm-4 col-6">
        <a href="#" class="list-of-special-categories__link">
            <figure class="list-of-special-categories__category">
                <img src="../../common.blocks/list-of-special-categories/list-of-special-categories__confetti.svg" alt="" class="list-of-special-categories__category-img">
...
<!-- List of special categories -->
    ...
    <section class="index-page__list-of-popular-models pt-4 pb-4">
        <div class="container">
...
<!-- /Add to favorite -->
        <a href="/product.html" class="complect-item__image" style="background-image: url(/content/images/complects/complect__example-1.jpg);"></a>
        <h3 class="complect-item__title"><a href="/product.html">Комплект платьев Мечта</a></h3>
...
<!-- /Add to favorite -->
        <a href="/product.html" class="complect-item__image" style="background-image: url(/content/images/complects/complect__example-2.jpg);"></a>
        <h3 class="complect-item__title"><a href="/product.html">Комплект платьев Мечта</a></h3>
        <ul class="complect-item__details">
...
<!-- /Add to favorite -->
        <a href="/product.html" class="complect-item__image" style="background-image: url(/content/images/complects/complect__example-3.jpg);"></a>
        <h3 class="complect-item__title"><a href="/product.html">Комплект платьев Мечта</a></h3>
        <ul class="complect-item__details">
...
<!-- /Add to favorite -->
        <a href="/product.html" class="complect-item__image" style="background-image: url(/content/images/complects/complect__example-4.jpg);"></a>
        <h3 class="complect-item__title"><a href="/product.html">Комплект платьев Мечта</a></h3>
        <ul class="complect-item__details">
...
<!-- /Add to favorite -->
        <a href="/product.html" class="complect-item__image" style="background-image: url(/content/images/complects/complect__example-5.jpg);"></a>
        <h3 class="complect-item__title"><a href="/product.html">Комплект платьев Мечта</a></h3>
        <ul class="complect-item__details">
...
<!-- /Add to favorite -->
        <a href="/product.html" class="complect-item__image" style="background-image: url(/content/images/complects/complect__example-6.jpg);"></a>
        <h3 class="complect-item__title"><a href="/product.html">Комплект платьев Мечта</a></h3>
        <ul class="complect-item__details">
...
<!-- /Add to favorite -->
        <a href="/product.html" class="complect-item__image" style="background-image: url(/content/images/complects/complect__example-7.jpg);"></a>
        <h3 class="complect-item__title"><a href="/product.html">Комплект платьев Мечта</a></h3>
        <ul class="complect-item__details">
...
<!-- /Add to favorite -->
        <a href="/product.html" class="complect-item__image" style="background-image: url(/content/images/complects/complect__example-8.jpg);"></a>
        <h3 class="complect-item__title"><a href="/product.html">Комплект платьев Мечта</a></h3>
        <ul class="complect-item__details">
...
<!-- /List of popular complects -->
    ...
    <section class="index-page__list-of-popular-models pt-4 pb-4 bg-light index-page__shaped-bg">
        <div class="container">
				...
				<section class="page-footer__section page-footer__menu-section">
					...
					<nav class="page-footer__nav page-footer__nav_type_menu collapse">
						<ul class="page-footer__list-of-links page-footer__menu-list-of-links">
							...
							<li class="nav-item nav-item_type_social"><a href="#" class="page-footer__nav-link"><i class="icon icon__instagram icon_style_light mr-2 d-none d-lg-inline-block"></i>Instagram</a></li>
							<li class="nav-item"><a href="#" class="page-footer__nav-link"><i class="icon icon__vk icon_style_light  mr-2 d-none d-lg-inline-block"></i>Вконтакте</a></li>
						</ul>
					</nav>
				</section>
			</li>
				...
				<section class="page-footer__section">
					...
					<nav class="page-footer__nav page-footer__nav_type_for-family collapse">
						<ul class="page-footer__list-of-links">
							...
							<li class="nav-item"><a href="#" class="page-footer__nav-link">Наряды с платьями</a></li>
							<li class="nav-item"><a href="#" class="page-footer__nav-link">Свитшоты и толстовки</a></li>
							...
							<li class="nav-item"><a href="#" class="page-footer__nav-link">Аксессуары</a></li>
						</ul>
					</nav>
				</section>
			</li>
				...
				<section class="page-footer__section">
					...
					<nav class="page-footer__nav page-footer__nav_type_moms-and-daughter collapse">
						<ul class="page-footer__list-of-links">
							...
							<li class="nav-item"><a href="#" class="page-footer__nav-link">Свитшоты и худи</a></li>
							<li class="nav-item"><a href="#" class="page-footer__nav-link">Рубашки</a></li>
							<li class="nav-item"><a href="#" class="page-footer__nav-link">Свитера</a></li>
							<li class="nav-item"><a href="#" class="page-footer__nav-link">Аксессуары</a></li>
						</ul>
				...
				<section class="page-footer__section">
					...
					<nav class="page-footer__nav page-footer__nav_type_moms-and-sons collapse">
						<ul class="page-footer__list-of-links">
							<li class="nav-item"><a href="#" class="page-footer__nav-link">Футболки</a></li>
							<li class="nav-item"><a href="#" class="page-footer__nav-link">Рубашки</a></li>
							<li class="nav-item"><a href="#" class="page-footer__nav-link">Комплекты</a></li>
							<li class="nav-item"><a href="#" class="page-footer__nav-link">Свитера</a></li>
							<li class="nav-item"><a href="#" class="page-footer__nav-link">Свитшоты и толстовки</a></li>
							<li class="nav-item"><a href="#" class="page-footer__nav-link">Аксессуары</a></li>
						</ul>
				...
				<section class="page-footer__section">
					...
					<nav class="page-footer__nav page-footer__nav_type_dads-and-sons collapse">
						<ul class="page-footer__list-of-links">
							<li class="nav-item"><a href="#" class="page-footer__nav-link">Футболки</a></li>
							<li class="nav-item"><a href="#" class="page-footer__nav-link">Наряды с платьями</a></li>
							<li class="nav-item"><a href="#" class="page-footer__nav-link">Толстовки и свитшоты</a></li>
							<li class="nav-item"><a href="#" class="page-footer__nav-link">Рубашки</a></li>
							<li class="nav-item"><a href="#" class="page-footer__nav-link">Свитера</a></li>
							<li class="nav-item"><a href="#" class="page-footer__nav-link">Аксессуары</a></li>
						</ul>
				...
				<section class="page-footer__section">
					...
					<nav class="page-footer__nav page-footer__nav_type_contacts collapse">
						<ul class="page-footer__list-of-contacts">
							...
							<li class="nav-item mb-2"><a href="mailto:info@BeFamily-Shop.ru" class="page-footer__link">info@BeFamily-Shop.ru</a></li>
							<li class="nav-item">
