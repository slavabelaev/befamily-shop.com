...
<link rel="stylesheet" href="pages/for-wholesalers/for-wholesalers.css">
<!-- For wholesalers page -->
<main class="for-wholesalers-page">
    <article>
        <header class="for-wholesalers__page-header text-white mb-4">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <img src="pages/for-wholesalers/for-wholesalers__header-image.png" alt="" class="mw-100">
                    </div>
                    <div class="col-md-6">
        ...
        <div class="container">
            <section class="about-page__section">
                ...
                <section>
                    <h2 class="text-center">Почему сотрудничать с нами выгодно и приятно?</h2>
                    <ul class="row list-unstyled text-center">
                        ...
                        <li class="col-sm-6 col-md-4 col-lg-3">
                            <figure class="figure">
                                ...
                                <figcaption class="figure-caption">Все товары, в наличии  на складе в Москве</figcaption>
                            </figure>
                        </li>
                        <li class="col-sm-6 col-md-4 col-lg-3">
                            <figure class="figure">
