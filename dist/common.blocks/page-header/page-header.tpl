	...
	<nav class="navbar navbar-expand-lg navbar-light container">
		...
		<div class="page-header__navbar collapse navbar-collapse">
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item">
					<a class="nav-link" href="/pages/about-page/about-page.html">О нас</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="/pages/for-wholesalers-page/for-wholesalers-page.html">Оптовикам</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="/pages/blog-page/blog-page.html">Блог</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="/pages/contacts-page/contacts-page.html">Контакты</a>
				</li>
            </ul>
        </div>
		<ul class="page-header__navbar-actions">
			<li class="nav-item">
				<a class="nav-link" href="/pages/favorites-page/favorites-page.html">
                    <span class="icon icon__heart icon_style_dark"></span>
					<span class="page-header__number-of-favorites badge badge-primary">66</span>
                </a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="/pages/cart-page/cart-page.html">
