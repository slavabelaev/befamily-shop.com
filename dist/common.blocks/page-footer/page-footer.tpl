	...
	<div class="container">
		<ul class="page-footer__list-of-sections row">
			<li class="col-sm-4 col-lg-12">
				<section class="page-footer__section page-footer__top-section">
					...
					<nav class="page-footer__nav page-footer__nav_type_menu collapse">
						<ul class="page-footer__list-of-links page-footer__main-list-of-links">
							...
							<li class="nav-item mr-lg-5"><a href="#" class="page-footer__nav-link">Контакты</a></li>
							<li class="nav-item ml-lg-5"><a href="#" class="page-footer__nav-link"><i class="icon icon__instagram icon_style_light  mr-2"></i>Instagram</a></li>
							<li class="nav-item"><a href="#" class="page-footer__nav-link"><i class="icon icon__vk icon_style_light  mr-2"></i>Вконтакте</a></li>
						</ul>
					</nav>
				</section>
			</li>
