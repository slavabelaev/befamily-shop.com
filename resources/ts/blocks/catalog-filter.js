$(document).ready(function () {
    var catalogFilterElement = $('.catalog-filter');
    if (catalogFilterElement.length < 1)
        return false;
    var $noUiSliderElement = $('[noui-slider]'), noUiSliderElement = $noUiSliderElement[0], noUiSliderMin = $noUiSliderElement.data('minPrice'), noUiSliderMax = $noUiSliderElement.data('maxPrice'), noUiSliderFromElement = $('[noui-slider-from]'), noUiSliderToElement = $('[noui-slider-to]');
