            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 text-center">
                        <img src="../../../public/images/delivery-page__header-image.png" alt="" class="mw-100 mt-md-4">
                    </div>
                </div>
            </div>
        </header>
        <div class="container">
            <section class="delivery-page__section">
                ...
                <ul class="row list-unstyled text-center mb-5">
                    <li class="col-sm-6 col-lg-3">
                        <figure class="figure mb-0">
                            <img src="../../../public/images/delivery-page__clock.svg" alt="" class="figure-img">
                    ...
                    <li class="col-sm-6 col-lg-3">
                        <figure class="figure mb-0">
                            <img src="../../../public/images/delivery-page__manager.svg" alt="" class="figure-img">
                            <figcaption class="figure-caption">
                    ...
                    <li class="col-sm-6 col-lg-3">
                        <figure class="figure mb-0">
                            <img src="../../../public/images/delivery-page__phone.svg" alt="" class="figure-img">
                            <figcaption class="figure-caption">
                    ...
                    <li class="col-sm-6 col-lg-3">
                        <figure class="figure mb-0">
                            <img src="../../../public/images/delivery-page__courier.svg" alt="" class="figure-img">
                            <figcaption class="figure-caption">
                ...
                <figure class="figure d-sm-flex align-items-center border border-primary mw-975 py-3 px-3 px-sm-5 mb-5 text-center text-sm-left">
                    <img src="../../../public/images/delivery-page__shirt.svg" alt="" class="figure-img mr-sm-5 mb-4 mb-sm-0">
                    <figcaption class="figure-caption">
