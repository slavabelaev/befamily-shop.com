            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 text-center">
                        <img src="../../../public/images/for-wholesalers-page__header-image.png" alt="" class="mw-100">
                    </div>
                </div>
            </div>
        </header>
                ...
                <section class="mb-5">
                    ...
                    <ul class="row list-unstyled text-center mb-0">
                        <li class="col-6 col-lg-3">
                            <figure class="figure">
                                <img src="../../../public/images/for-wholesalers-page__coin.svg" alt="" class="figure-img">
                                <figcaption class="figure-caption">Опт от 15 000 рублей</figcaption>
                            </figure>
                        </li>
                        <li class="col-6 col-lg-3">
                            <figure class="figure">
                                <img src="../../../public/images/for-wholesalers-page__Moscow.svg" alt="" class="figure-img">
                                <figcaption class="figure-caption">Производство в <br>России</figcaption>
                            </figure>
                        </li>
                        <li class="col-6 col-lg-3">
                            <figure class="figure">
                                <img src="../../../public/images/for-wholesalers-page__box.svg" alt="" class="figure-img">
                                <figcaption class="figure-caption">Все товары, в наличии на <br>складе в Москве</figcaption>
                            </figure>
                        </li>
                        <li class="col-6 col-lg-3">
                            <figure class="figure">
                                <img src="../../../public/images/for-wholesalers-page__label.svg" alt="" class="figure-img">
