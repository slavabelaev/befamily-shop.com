...
<header class="page-header" is-sticked>
	<nav class="navbar navbar-expand-lg navbar-light container">
		<a class="navbar-brand" href="index.html">
			<img src="images/blocks/page-header/page-header__be-Family.svg"
				 alt="be Family"
...
<ul class="slider" data-slick>
    <li class="slider__item" style="background-image: url(images/content/slider/slide-1.jpg);">
...
<ul class="list-of-special-categories row">
    <li class="list-of-special-categories__item col-md col-sm-4 col-6">
        <a href="catalog.html?filter[category]=photosession"
           class="list-of-special-categories__link">
            <figure class="list-of-special-categories__category">
                <img src="images/blocks/list-of-special-categories/list-of-special-categories__cinema.svg" alt=""
                     class="list-of-special-categories__category-img">
    ...
    <li class="list-of-special-categories__item col-md col-sm-4 col-6">
        <a href="catalog.html?filter[category]=for_a_present"
           class="list-of-special-categories__link">
            <figure class="list-of-special-categories__category">
                <img src="images/blocks/list-of-special-categories/list-of-special-categories__present.svg" alt=""
                     class="list-of-special-categories__category-img">
    ...
    <li class="list-of-special-categories__item col-md col-sm-4 col-6">
        <a href="catalog.html?filter[category]=first_birthday"
           class="list-of-special-categories__link">
            <figure class="list-of-special-categories__category">
                <img src="images/blocks/list-of-special-categories/list-of-special-categories__cake.svg" alt=""
                     class="list-of-special-categories__category-img">
    ...
    <li class="list-of-special-categories__item col-md col-sm-4 col-6">
        <a href="catalog.html?filter[category]=warm_clothes"
           class="list-of-special-categories__link">
            <figure class="list-of-special-categories__category">
                <img src="images/blocks/list-of-special-categories/list-of-special-categories__clothes.svg" alt=""
                     class="list-of-special-categories__category-img">
    ...
    <li class="list-of-special-categories__item col-md col-sm-4 col-6">
        <a href="catalog.html?filter[category]=summer_rest"
           class="list-of-special-categories__link">
            <figure class="list-of-special-categories__category">
                <img src="images/blocks/list-of-special-categories/list-of-special-categories__sun-umbrella.svg"
    ...
    <li class="list-of-special-categories__item col-md col-sm-4 col-6">
        <a href="catalog.html?filter[category]=on_holiday"
           class="list-of-special-categories__link">
            <figure class="list-of-special-categories__category">
                <img src="images/blocks/list-of-special-categories/list-of-special-categories__confetti.svg"
                     alt="" class="list-of-special-categories__category-img">
...
<div class="complect-item card">
    <div class="card-body">
        ...
        <a href="product.html?complectId=0109" class="complect-item__image" style="background-image: url(images/content/complects/complect__example-1.jpg);"></a>
...
<div class="complect-item card">
    <div class="card-body">
        ...
        <a href="product.html?complectId=0110" class="complect-item__image" style="background-image: url(images/content/complects/complect__example-2.jpg);"></a>
        <h3 class="complect-item__title">
...
<div class="complect-item card">
    <div class="card-body">
        ...
        <a href="product.html?complectId=0111" class="complect-item__image" style="background-image: url(images/content/complects/complect__example-3.jpg);"></a>
        <h3 class="complect-item__title">
...
<div class="complect-item card">
    <div class="card-body">
        ...
        <a href="product.html?complectId=0112" class="complect-item__image" style="background-image: url(images/content/complects/complect__example-4.jpg);"></a>
        <h3 class="complect-item__title">
...
<div class="complect-item card">
    <div class="card-body">
        ...
        <a href="product.html?complectId=0113" class="complect-item__image" style="background-image: url(images/content/complects/complect__example-5.jpg);"></a>
        <h3 class="complect-item__title">
            <a href="product.html?complectId=0113" class="complect-item__title-link">Комплект платьев Мечта</a>
        </h3>
        <ul class="complect-item__details">
            <li class="complect-item__detail complect-item__uid">Артикул: 0113</li>
            <li class="complect-item__detail complect-item__price">10890 ₽</li>
            <li class="complect-item__detail text-right">
                <a href="#"
                   class="complect-item__added-to-cart"
...
<div class="complect-item card">
    <div class="card-body">
        ...
        <a href="product.html?complectId=0114" class="complect-item__image" style="background-image: url(images/content/complects/complect__example-6.jpg);"></a>
        <h3 class="complect-item__title">
            <a href="product.html?complectId=0114" class="complect-item__title-link">Комплект платьев Мечта</a>
        </h3>
        <ul class="complect-item__details">
            <li class="complect-item__detail complect-item__uid">Артикул: 0114</li>
            <li class="complect-item__detail complect-item__price">10890 ₽</li>
            <li class="complect-item__detail text-right">
                <a href="#"
                   class="complect-item__added-to-cart"
...
<div class="complect-item card">
    <div class="card-body">
        ...
        <a href="product.html?complectId=0115" class="complect-item__image" style="background-image: url(images/content/complects/complect__example-7.jpg);"></a>
        <h3 class="complect-item__title">
            <a href="product.html?complectId=0115" class="complect-item__title-link">Комплект платьев Мечта</a>
        </h3>
        <ul class="complect-item__details">
            <li class="complect-item__detail complect-item__uid">Артикул: 0115</li>
            <li class="complect-item__detail complect-item__price">10890 ₽</li>
            <li class="complect-item__detail text-right">
                <a href="#"
                   class="complect-item__added-to-cart"
...
<div class="complect-item card">
    <div class="card-body">
        ...
        <a href="product.html?complectId=0116" class="complect-item__image" style="background-image: url(images/content/complects/complect__example-8.jpg);"></a>
        <h3 class="complect-item__title">
            <a href="product.html?complectId=0116" class="complect-item__title-link">Комплект платьев Мечта</a>
        </h3>
        <ul class="complect-item__details">
            <li class="complect-item__detail complect-item__uid">Артикул: 0116</li>
            <li class="complect-item__detail complect-item__price">10890 ₽</li>
            <li class="complect-item__detail text-right">
                <a href="#"
                   class="complect-item__added-to-cart"
...
<ul class="list-of-gallery-images row list-unstyled">
    <li class="list-of-gallery-images__item col-6 col-sm-4 col-md-3 col-lg-2">
        <a data-fancybox="gallery"
           ...
           href="images/content/we-are-in-socials/image-1.jpg"
           style="background-image: url(images/content/we-are-in-socials/image-1.jpg);"></a>
    </li>
    <li class="list-of-gallery-images__item col-6 col-sm-4 col-md-3 col-lg-2">
        <a data-fancybox="gallery"
           class="list-of-gallery-images__link"
           href="images/content/we-are-in-socials/image-2.jpg"
           style="background-image: url(images/content/we-are-in-socials/image-2.jpg);"></a>
    </li>
    <li class="list-of-gallery-images__item col-6 col-sm-4 col-md-3 col-lg-2">
        <a data-fancybox="gallery"
           class="list-of-gallery-images__link"
           href="images/content/we-are-in-socials/image-3.jpg"
           style="background-image: url(images/content/we-are-in-socials/image-3.jpg);"></a>
    </li>
    <li class="list-of-gallery-images__item col-6 col-sm-4 col-md-3 col-lg-2">
        <a data-fancybox="gallery"
           class="list-of-gallery-images__link"
           href="images/content/we-are-in-socials/image-4.jpg"
           style="background-image: url(images/content/we-are-in-socials/image-4.jpg);"></a>
    </li>
    <li class="list-of-gallery-images__item col-6 col-sm-4 col-md-3 col-lg-2">
        <a data-fancybox="gallery"
           class="list-of-gallery-images__link"
           href="images/content/we-are-in-socials/image-5.jpg"
           style="background-image: url(images/content/we-are-in-socials/image-5.jpg);"></a>
    </li>
    <li class="list-of-gallery-images__item col-6 col-sm-4 col-md-3 col-lg-2">
        <a data-fancybox="gallery"
           class="list-of-gallery-images__link"
           href="images/content/we-are-in-socials/image-6.jpg"
           style="background-image: url(images/content/we-are-in-socials/image-6.jpg);"></a>
    </li>
    <li class="list-of-gallery-images__item col-6 col-sm-4 col-md-3 col-lg-2">
        <a data-fancybox="gallery"
           class="list-of-gallery-images__link"
           href="images/content/we-are-in-socials/image-7.jpg"
           style="background-image: url(images/content/we-are-in-socials/image-7.jpg);"></a>
    </li>
    <li class="list-of-gallery-images__item col-6 col-sm-4 col-md-3 col-lg-2">
        <a data-fancybox="gallery"
           class="list-of-gallery-images__link"
           href="images/content/we-are-in-socials/image-8.jpg"
           style="background-image: url(images/content/we-are-in-socials/image-8.jpg);"></a>
    </li>
    <li class="list-of-gallery-images__item col-6 col-sm-4 col-md-3 col-lg-2">
        <a data-fancybox="gallery"
           class="list-of-gallery-images__link"
           href="images/content/we-are-in-socials/image-9.jpg"
           style="background-image: url(images/content/we-are-in-socials/image-9.jpg);"></a>
    </li>
    <li class="list-of-gallery-images__item col-6 col-sm-4 col-md-3 col-lg-2">
        <a data-fancybox="gallery"
           class="list-of-gallery-images__link"
           href="images/content/we-are-in-socials/image-10.jpg"
           style="background-image: url(images/content/we-are-in-socials/image-10.jpg);"></a>
    </li>
    <li class="list-of-gallery-images__item col-6 col-sm-4 col-md-3 col-lg-2">
        <a data-fancybox="gallery"
           class="list-of-gallery-images__link"
           href="images/content/we-are-in-socials/image-11.jpg"
           style="background-image: url(images/content/we-are-in-socials/image-11.jpg);"></a>
    </li>
    <li class="list-of-gallery-images__item col-6 col-sm-4 col-md-3 col-lg-2">
        <a data-fancybox="gallery"
           class="list-of-gallery-images__link"
           href="images/content/we-are-in-socials/image-12.jpg"
           style="background-image: url(images/content/we-are-in-socials/image-12.jpg);"></a>
    </li>
</ul>
<!-- /List of gallery images -->
        ...
        <ul class="page-footer__list-of-sections page-footer__list-of-sections_type_bottom row">
                ...
                <section class="page-footer__section page-footer__developed-by-section">
                    ...
                    <a target="_blank"
                       ...
                       class="page-footer__link">
                        <img src="images/blocks/page-footer/page-footer__WEBDELO-STUDIO.svg"
                             alt="WEBDELO STUDIO"
            ...
            <li class="page-footer__section-item_part_copyright col-md-4">
                <section class="page-footer__section page-footer__copyright-section">
                    ...
                    <a href="index.html"
                       class="page-footer__link">
                        <img src="images/blocks/page-footer/page-footer__be-Family.svg"
                             alt="be Family"
